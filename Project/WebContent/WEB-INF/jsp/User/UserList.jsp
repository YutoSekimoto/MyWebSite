		...
		<div class="form-search">
			<form action="UserListServlet" method="post">
				<div class="form-group">
					<label for="exampleInputLoginid">ログインID</label> <input type="text" class="form-control" id="exampleInputLoginid" placeholder="LoginId" name="loginId">
				</div>
				<div class="form-group">
					<label for="exampleInputName">ユーザー名</label> <input type="text" class="form-control" id="exampleInputName" placeholder="Name" name="name">
				</div>
				<div class="form-group">
					<label for="exampleInputEmail">メールアドレス</label> <input type="email" class="form-control" id="exampleInputEmail" placeholder="Email" name="email">
				</div>
				<div class="form-group">
				...
				<tbody>
					<c:forEach var="oneUser" items="${userList}">
						<tr>
							...
							<td><a href="UserDetailServlet?id=<c:out value="${oneUser.id }" />" class="btn btn-primary">詳細</a> <c:if test="${usersession.loginId == 'admin'}">
